...
/**
 * Dashboard — WebView host for portal/dashboard.html.
 *
 * The web page provides the full Entity grid + Org Chart tabs (parity with Web).
 */
class DashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        AiChatFabHelper.setup(this, "dashboard")
        setupWindowInsets()
        setupWebView()
    }
    ...
    private fun setupWebView() {
        val container = findViewById<FrameLayout>(R.id.dashboardWebViewContainer)
            ...
            webViewClient = object : WebViewClient() {
                override fun shouldOverrideUrlLoading(
                    ...
                    try {
                        ...
                        Timber.e(e, "[Dashboard] Failed to open external URL: $url")
                    }
                    return true
                }
                ...
                override fun onPageFinished(view: WebView?, url: String?) {
                    ...
                    Timber.d("[Dashboard] WebView page loaded: $url")
    ...
    override fun onDestroy() {
        webView?.destroy()
        webView = null
        Timber.d("[Dashboard] onDestroy: WebView cleaned up")
        super.onDestroy()
    }
}
