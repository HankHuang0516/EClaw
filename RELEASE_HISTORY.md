...
## Latest
v1.0.92 | pending PR | 2026-06-14 | versionCode 100 | Production release prep | **Health-checking animation parity + Petdx pagination rollup**: Android wallpaper/entity cards and iOS entity cards now render the backend `healthChecking` state with visible animation; passive health/self-repair backend flow is included; Petdx browser pagination, chat routing fallback, redirect/i18n/API error, Plaza, chat, arena, and rental reliability fixes are bundled.
