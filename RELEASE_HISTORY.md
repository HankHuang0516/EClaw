...
## Latest
v1.1.14 | pending | 2026-06-28 | versionCode 125 | Production rollout 🚧 (promotes the live wallpaper-settings + walking-behavior work from `origin/main`; production baseline was v1.0.96/vc104, internal had reached v1.1.13/vc124) | **Live wallpaper 桌布設定 + 行走行為 fixes**: free-walking (行走功能) reconnect plus walking-toggle de-dupe (#3785), drag-to-reposition HARD PIN with configured-vs-displayed desync fix for entity #10 (#3790), and the activity-state FSM Stage 3 client that consumes server-authoritative BUSY/REVIEW/IDLE/SLEEPING state and fixes the error→false-sleep path (#3791). Also carries the already-shipped wallpaper black-screen NPE guard and the post-1.0.96 backend/portal/security rollup now on `origin/main`. The two residual black-screen hardening PRs (#3709 TtsService :tts isolation, #3704 never-black render floor) were intentionally dropped per owner decision — 1.1.13 already cleared the reported black screen with no further black-screen reports.

v1.0.96 | pending | 2026-06-21 | versionCode 104 | Release candidate 🚧 | **Wallpaper, chat, reconnect, and push reliability rollup**: ships the post-v1.0.95 Android changes now on `origin/main`, including wallpaper kanban v2 rendering/assets, folder-depth and whiteboard text fitting polish, wallpaper offline entity/spritesheet cache, purposeful movement and interaction states, Android WebView reconnect overlay, chat send-to picker and partner-avatar accessibility fixes, routing-chip modal fallback, global web-push auto-enable plus push health cleanup, kanban schedule usage-threshold controls, portal reconnect overlay, and compare/marketplace/onboarding/about-founder scanning polish.

v1.0.95 | 1c20edd0 | 2026-06-21 | versionCode 103 | Production ✅ (Play Console submission 68, Play API `completed`, published 2026-06-21 14:29 TW) | **Scheduled Play release baseline**: bumped Android to versionCode 103 / versionName 1.0.95 for the scheduled Play production release; Google Play production and internal tracks now report 1.0.95 completed.

v1.0.94 | 48605067 | 2026-06-20 | versionCode 102 | Production ✅ (Play Console submission 67, published 2026-06-20 18:41 TW) | **FCM Kanban done notification channel fix**: released the kanban-done notification channel fix to production and superseded the v1.0.93 release-candidate line.

v1.0.93 | pending | 2026-06-19 | versionCode 101 | Release candidate 🚧 | **Push notification settings parity + Google Play Console coverage rollup**: Android native Settings now exposes the Web/backend notification categories for `@mention` pings and rich-card questions, keeps the same category order as the portal, and mirrors the portal Feedback toggle by updating both `feedback_resolved` and `feedback_reply`. Also prepares Android App Links release readiness for `/r/` plus Play Integrity API startup and billing-action reporting, Billing Library 9.1.0, server-side Play Integrity decode/verification gates, safe debug diagnostics, and a coverage verifier for Play Console deep links, Play Integrity, licensing, app certificate, billing, and optional risk signals.
