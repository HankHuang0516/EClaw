...
#       temporary focusing.
#
#   (2) You need a Java 8+ JDK/JRE installed and accessible in the PATH.
#
##############################################################################
...
# Collect all arguments for the java command, stracks://issues.grails.org/browse/GRAILS-2471
# doesn't affect the arguments for Gradle.
#
