#!/usr/bin/env python3
"""Add more Spanish translations - correct indentation"""
import re
...
if existing_stripped.endswith(','):
    existing_stripped = existing_stripped[:-1]

# Build new es block
new_es = f'\n    es: {{{existing_stripped}\n{new_entries_str}\n    }},\n'
