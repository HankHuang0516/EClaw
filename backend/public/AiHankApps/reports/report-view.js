// Generated from report-view.mjs; do not edit directly.
(function () {
const FIELDS = {
...
function combinedAcquisition(app) {
...
function formatValue(value, field, fallback = '官方資料待補') {
...
function automaticGranularity(start, end) {
...
function chartBuckets(apps, field, granularity, start, end, options = {}) {
...
function missingReason(app, field) {
...
function sortApps(apps, key, direction = 'desc') {
