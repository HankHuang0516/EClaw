(() => {
  ...
  const apps = {
    ...
    '活字戰紀：雙城烽火': { id: 'typeforge-twin-cities', guide: 'https://eclawbot.com/AiHankApps/guides/typeforge/', guideLabel: '閱讀完整攻略', shots: ['typeforge/01.jpg','typeforge/02.jpg','typeforge/03.jpg','typeforge/04.jpg','typeforge/05.jpg','typeforge/06.jpg','typeforge/07.jpg','typeforge/08.jpg'] },
  ...
  function addGuideLink(card, heading, config) {
    ...
    link.setAttribute('aria-label', `${heading.textContent.trim()}：${label}`);
