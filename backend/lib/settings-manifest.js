            ...
            fields: [
                ...
                },
                {
                    ...
                    help: {
                        ...
                        fallback: 'Choose what the timeout worker does after the unanswered window.',
                    },
                    scope: 'device',
                    default: 'keep',
                    validation: {
                        ...
                        options: [
                            ...
                            { value: 'auto_dismiss', label: { i18n: 'action_request_timeout_auto_dismiss', fallback: 'Auto-dismiss' } },
                            { value: 'safe_default', label: { i18n: 'action_request_timeout_safe_default', fallback: 'Safe default' } },
                            { value: 'consensus', label: { i18n: 'action_request_timeout_consensus', fallback: 'Consensus' } },
                        ],
                    },
                },
                {
                    ...
                    type: 'number',
                    control: 'stepper',
                    label: { i18n: 'action_request_timeout_minutes_label', fallback: 'Unanswered window (minutes)' },
                    help: {
                        i18n: 'action_request_timeout_minutes_desc',
                        fallback: 'Run the selected policy after this many minutes without a reply.',
                    },
                    scope: 'device',
                    default: 1440,
                    validation: { required: false, min: 5, max: 43200, step: 1, unit: 'minutes' },
                },
            ],
        },
    },
